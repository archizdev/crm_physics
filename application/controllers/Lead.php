...
<h5 style="color:red;">' . $myalertmobile . '</h5>
    ...
    public function get_product_by_cat_or_subcat(){
        $cat = $this->input->post('product_category');
        $subcat = $this->input->post('product_subcategory');
        if($cat){
        ...
        $this->db->where('comp_id',$this->session->companey_id);
        $res = $this->db->get('tbl_product_country')->result_array();
...
<iframe src="https://117.247.252.26:8443/dashboard/index?userId=osepa@archizsolutions.com&userName=osepa@archizsolutions.com&sessionId=d753-60e30a04-ses-osepa@archizsolutions.com-yvBPss75-29&userType=Professional-Agent&campaignId=1&crmSessionId=undefined&userCrtObjectIds=[%27d753-60e30a04-ses-osepa@archizsolutions.com-yvBPss75-29-uce-5%27]&instanceId=instance_738686&session-id=d753-60e30a04-ses-osepa@archizsolutions.com-yvBPss75-29&locale=en&origin=http://117.247.252.25:8888&iframeId=iframe_903857" height="600" width="700" title="Iframe Example"></iframe>
