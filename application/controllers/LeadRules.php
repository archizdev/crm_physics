...
class LeadRules extends CI_Controller {
    ...
    public function create_rule($id=0){
        ...
        $data['whatsapp_api_list'] = $this->Apiintegration_Model->get_api_list(1);
        $data['sms_api_list'] = $this->Apiintegration_Model->get_api_list(2);
        $data['email_api_list'] = $this->Apiintegration_Model->get_email_list();
        
        // echo "<pre>";
        // print_r($data['whatsapp_api_list']);
        // print_r($data['sms_api_list']);
        // print_r($data['email_api_list']);
        // exit;
