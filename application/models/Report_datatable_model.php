        ...
        if($all){
           ...
           if($employe!=''){                        
            ...
            if($all!='' || $updated_from || $updated_to){
                ...
                if($call_access){
                    $this->db->join('tbl_col_log2','tbl_col_log2.call_id=tbl_comment.call_id','left');
                    $select .= ",tbl_col_log2.call_id,tbl_col_log2.dur,tbl_col_log2.customer_phone,tbl_col_log2.call_status,tbl_col_log2.event_type,tbl_col_log2.agent_id,tbl_col_log2.agent_id";
                }
            }
