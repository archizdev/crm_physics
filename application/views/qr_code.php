      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="row">
               ...
               <div class="form-group   col-sm-6">
                  <label>Process*</label>
                  <select class="form-control" name="process" id='qr-process-fields'>
            ...
            <div class='col-md-12' id='form-fields'>
...
<script>
   ...
   $("#qr-process-fields").on('change',function(){
      process_val = $(this).val();      
      $.ajax({
            url: "<?=base_url().'configurations/get_fields_by_process/'?>",
            type: 'post',            
            data:{
               'id':process_val
            },
            success: function(responseData){               
               $("#form-fields").html(responseData);
            }
      });
   });
