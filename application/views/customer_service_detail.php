  ...
  <div class="col-md-12">
    ...
    <div class="row" style="padding-left: 2px;">       
      ...
      <div class="col-md-8" style="min-height: 8vh;padding: 15px 17px;">                        
        ...
        <h3 style="margin:0px;"><?php echo ucfirst($clientDetails->cl_name);?></h3>          
      ...
      <div class="col-md-4" style="min-height: 8vh;padding: 15px 15px;text-align: right">        
       ...
       <div class="col-md-12" style="min-height: calc(100vh - 105px);overflow: auto;">
        ...
        <select class="form-control" id="AccountManager" name="AccountManager">
            ...
            <option></option><option value="Automatic">Automatic</option>

            <option value="dheeraj@archizsolutions.com">Dheeraj</option>

            <option value="lekhika@archizsolutions.com">Lekhika</option>

            <option selected="" value="shivam@archizsolutions.com">Shivam</option>

            <option value="newmail2chauhan@gmail.com">Shivam Chauhan</option></select>
