...
<input name="type" id="type" value="2" hidden> 
              ...
              <option value="1" <?php if(!empty($this->input->post('priority'))){if (1==$this->input->post('priority')) {echo 'selected';}}?>>Low</option>
                   ...
                   <div class="form-group col-md-3" id="statusfilter">
                    ...
                    <select name="ticket_status[]" class="form-control" multiple> 
                          <option value="">Select</option>
                         <?php 
                              if (!empty($ticket_status)) {
                              foreach ($ticket_status as $sub_stage_list) {?>
                              <option <?php if (!empty($this->input->post('ticket_status')) && in_array($sub_stage_list->id,$this->input->post('ticket_status'))) {echo 'selected';}?> value="<?=$sub_stage_list->id?>"><?=$sub_stage_list->status_name?> </option>
                              <?php 
...
<script type="text/javascript">
    ...
    // }
                    ...
                    <input type='checkbox' class="checked_all1" value="check all" >
                      ...
                      if($followup)
                      {
                        echo'<th>Ticket Subject</th><th>Activity Date</th>
                              <th>Ticket Stage</th>
