							...
							<div class="row">
								<div class="col-md-12">
									<ul class="nav nav-tabs">
									  ...
									  <li><a onclick="qr_load()" data-toggle="tab" href="#cmp-custom_qr"><?php echo 'Custom QR Form'; ?> </a></li>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="a_branch" type="text" class="form-control" id="firstname" placeholder="<?php echo display('customer_account_branch')?>" value="<?php echo $doctor->a_branch ?>" >
									  ...
									  <div id="cmp-custom_qr" class="tab-pane fade">
                                            <div class="row" id="qr_view">
...
function qr_load()
{
    url = "<?=base_url().'form/form/enquiry_extra_field/'?>"+"<?=$doctor->user_id?>/1/3";     
        $.ajax({
          type: "POST",
          url: url,      
          success: function(data){
...
$("a[data-toggle='tab']").click(function(){
          var a    =   $(this).attr('href');
          if(a == "#cmp-custom_form" || a=="#cmp-custom_ticket" || a=="#cmp-custom_qr"){            
              $(".comp-status").hide();
              $(".form-btns").hide();
          }else{
              $(".comp-status").show();
