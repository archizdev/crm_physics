...
<div class="row">
 <div class="row" style="background-color: #fff;padding:7px;border-bottom: 1px solid #C8CED3;">  
      ...
      <?php if(!empty($this->session->telephony_token)){ ?>
            ...
            if(user_access(1070)){
            ?> 
              <a class="btn" data-toggle="modal" data-target="#tagas" style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;" onclick='make_tag_indeterminate()'><?php echo 'Tag AS'; ?></a>   
              <?php } 
              if(user_access(224)){
              ?> 
              <a class="btn" href='javascript:void(0)' style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;" onclick='myoperatory_bulk_dial()'><?php echo 'Bulk Dial'; ?></a>   
              <?php } ?>  
              <?php
              if(($data_type ==1 && user_access(62)) || ($data_type ==2 && user_access(72)) || ($data_type ==1 && user_access(82))){ ?>                    
              <a class="btn" data-toggle="modal" data-target="#deleteselected" style="color:#000;cursor:pointer;border-radius: 2px;border-bottom: 1px solid #fff;"><?php echo 'Delete Data'; ?></a>                         
              <?php
              }
              ?>
            </div>                                         
            ...
            <div class="panel panel-default">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-3" id="todatefilter">
                         ...
                         <div class="form-group col-md-3" id="sourcefilter">
                          ...
                          <select class="form-control" name="source" id="source">
                              ...
                              <?php }?>
                              <option value='0' <?php if('0'==$filterData['source']) {echo 'selected';}?>>NA</option>
                        ...
                        <div class="form-group col-md-3" id="subsourcefilter">
                          ...
                          <select class="form-control" name="subsource" id="subsource">
                              ...
                              <?php }?>
                              <option value='0' <?php if('0'==$filterData['subsource']) {echo 'selected';}?>>NA</option>
                     ...
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-3" id="datasourcefilter">
                          ...
                          <select  class="form-control" name="datasource" id="datasource">
                              ...
                              <?php }?>
                              <option value='0' <?php if('0'==$filterData['datasource']) {echo 'selected';}?>>NA</option>
                          </select>
                        </div>
                        ...
                        <div class="form-group col-md-3" id="phonefilter">
                         ...
                         <?php 
                          if (!empty($created_bylist)) {
                              ...
                              <?php }}?>  
                              <option value='0' <?php if('0'==$filterData['createdby']) {echo 'selected';}?>>NA</option>  
                         </select>                       
                        </div>
                    ...
                    <select name="prodcntry" class="form-control"> 
                         ...
                         <?php 
                              ...
                              <?php }}?>   
                              <option value='0'  <?php if('0'==$filterData['prodcntry']) {echo 'selected';}?>>NA</option> 
                    </select> 
                    </div> 
                    ...
                    <select name="state" class="form-control" id="state"> 
                         ...
                         <?php 
                              ...
                              <?php }}?>
                              <option value='0' <?php if('0'==$filterData['state']) {echo 'selected';}?>>NA</option>    
                    </select> 
                    </div> 
                    ...
                    <select name="city" class="form-control" id="city_name"> 
                      <option value="">Select</option>
                           <?php 
                              ...
                              <?php }}?> 
                              <option value='0' <?php if('0'==$filterData['city']) {echo 'selected';}?>>NA</option>  
                    </select> 
                    </div> 
                        ...
                        <select name="probability" class="form-control">
                          ...
                          if(!empty($lead_score)){
                            foreach ($lead_score as $prob) {  ?>
                              ...
                              ?>
                              <option value='0' <?php if(array_key_exists('probability',$filterData) && '0'==$filterData['probability']) {echo 'selected';}?>>NA</option>
                        </select>
                      </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               ...
               <br>
               <br>
               <div class='col-md-12' id='tags_checkbox'>                   
               </div>
            </div>
               <br>
               <br>
...
function moveto_client(){
  console.log($('.checkbox1:checked').size());
  if($('.checkbox1:checked').size() > 1000){
...
$('.multiple-select').select2();
  function mark_tag(){
    var inputs = document.getElementsByClassName("make-indeterminate");
    var indem = [];
    var checked = [];
    var unchecked = [];
    var enquiry_id = [];
    $('input[name="enquiry_id[]"]:checked').each(function(){
      enquiry_id.push(this.value);
    });
    for (var i = 0; i < inputs.length; i++) {
      if(inputs[i].indeterminate){        
        indem.push(inputs[i].value);
      }
    }
    ...
    $('input[name="tags[]"]:not(:checked)').each(function(){
  ...
  function make_tag_indeterminate(){
    var form_data = $("#enquery_assing_from").serialize();  
    $.ajax({
      url: '<?=base_url()?>enquiry/tags_checkboxs',
      type: 'post',
      data: form_data,
      success: function(responseData){        
        $("#tags_checkbox").html(responseData);
        var inputs = document.getElementsByClassName("make-indeterminate");
        for (var i = 0; i < inputs.length; i++) {
...
if(user_access(224)){?>
<script>
  function myoperatory_bulk_dial(){  
    if($('.checkbox1:checked').size() > 0){      
      var form_data = $("#enquery_assing_from").serialize();  
      $.ajax({
        url: '<?=base_url()?>enquiry/bulk_dial_myoperator',
        type: 'post',
        data: form_data,
          ...
          beforeSend: function() {
            ...
            success: function(data) {
                ...
                alert('Call initialize Successfully')
            }
