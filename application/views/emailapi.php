                                    ...
                                    <div class="modal-body">
                                       ...
                                       <div class="row">
                                          <div class="form-group col-sm-6">
                                             ...
                                             <select name='type' class='form-control' id='integration_type'>
                                                <option value='1' value="<?=$list['type']?>" <?php if($list['type']==1) {echo 'selected';} ?>>
                                                SMTP
                                                </option>
                                                <option value='2' value="<?=$list['type']?>" <?php if($list['type']==2) {echo 'selected';} ?>>
                                                Sendinblue
                                                </option>
                                             </select>
                                          </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="row">
               ...
               <div class="form-group col-sm-6">
                  <label id='smpt-host'>SMTP HOST*</label>
               ...
               <div class="form-group col-sm-6 smtp-field">
                  <label id='smtp-port'>SMTP Port*</label>
...
<script>
   ...
   $("#integration_type").on('change',function(){
      var integration   =  $(this).val();
      if(integration == 1){
         $(".smtp-field").show();
         $("#smtp-host").text('SMTP HOST*');
         $("#smtp-user").text('SMTP User*');
         $("#smtp-protcol").text('Protocol*');
         $("#smtp-password").text('SMTP Password*');
      }else if(integration == 2){
         $(".smtp-field").hide();
         $("#smtp-host").text('API Endpoint*');
         $("#smtp-user").text('Sender Email*');         
         $("#smtp-protcol").text('Sender Name*');
         $("#smtp-password").text('API Key*');
      }
   });
   $("#integration_type").trigger('change');
</script>