                    ...
                    <div class="form-row col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select data-placeholder="Begin typing a name to filter..." multiple class="form-control chosen-select"
                                ...
                                if(user_access(224)){
                                ?>
                                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call Duration',set_value('report_columns'))) {echo 'selected';}}?>>Call Duration</option>     

                                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call Status',set_value('report_columns'))) {echo 'selected';}}?> >Call Status</option>     

                                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call Id',set_value('report_columns'))) {echo 'selected';}}?> >Call Id</option>     
                                
                                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Agent Id',set_value('report_columns'))) {echo 'selected';}}?> >Agent Id</option>     

                                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call Type',set_value('report_columns'))) {echo 'selected';}}?> >Call Type</option>

                                <!-- <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call Recording',set_value('report_columns'))) {echo 'selected';}}?> >Call Recording</option> -->
