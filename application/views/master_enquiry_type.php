                                ...
                                <form action="<?php echo base_url('Enquiry/edit_customer_types')?>" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="input_cus_type" name="input_cus_type" value="<?= $row->customer_type ?>" required>
                                ...
                                <form action="<?php echo base_url('Enquiry/update_name_prefix')?>" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="name-prefix" name="name-prefix" value="<?= $prefix->prefix ?>" required>
        ...
        <form action="<?php echo base_url('Enquiry/add_customer_types')?>" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="input_cus_type" name="input_cus_type" required>
        ...
        <form action="<?php echo base_url('Enquiry/add_channel_partner_types')?>" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="channel_partner" name="channel_partner" required>
        ...
        <form action="<?php echo base_url('Enquiry/add_name_prefix')?>" method="post">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name_prefix" name="name_prefix" required>
