        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" id="lead-filter-form" class="lead-form" action="<?php echo base_url('Report/download_leads_report') ?>">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input   class="form-control form-date" id="from-date" name="from-date">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input   class="form-control form-date" id="to-date" name="todate">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" name="search_by_name" id="search_by_name" class="form-control" placeholder="Enter search name">
                       ...
                       <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="lead_score" id="lead_score" class="form-control" placeholder="Enter lead score">
