                    ...
                    <div class="tab-content clearfix">
                        ...
                        <div class="tab-pane active" id="tab-integration">
                            <?php if (user_access(54) == true) { ?>
                                ...
                                <button class="btn btn-sm btn-success" style="float: left" type="button" data-toggle="modal" data-target="#createnewintegration"><i class="fa fa-plus"></i> Add New
                                    Integration</button>
                                        ...
                                        <?php if (!empty($temp_list)) { ?>
                                            ...
                                            <?php foreach ($temp_list as $tlist) { ?>
                                                ...
                                                <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" style="cursor:pointer;" data-toggle="modal" data-target="#createnewtemplate<?php echo $tlist->temp_id; ?>">
                                                    ...
                                                    <td class="th0"><input type='checkbox' name='sel_temp[]' onclick="event.stopPropagation();" name='enquiry_id[]' class="checkboxtemp" value='<?php echo $tlist->temp_id; ?>'>&nbsp;
                                                        <?php echo $sl; ?></td>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group   col-sm-12">
                                                        ...
                                                        <label>Template ID (key,value)</label>



                                                        <input class="form-control" name="sms_template_id" type="text" value="<?php echo $tlist->sms_template_id; ?>">
