<style>
#basic > form > div:nth-child(3) > div.form-group.col-sm-6.col-md-6.enq-first-name > div > span > span > span.selection > span{
...
<div class="row">
   ...
   <div class="form-group col-sm-6 col-md-6 enq-first-name">
      ...
      <div class = "input-group" style="position:absolute;width:92%;">
         ...
         <input class="form-control" name="enquirername" type="text" value="<?php echo $details->first_name ?>" placeholder="Enter First Name" style="width:100%;" />
      </div>
   </div>
   <?php }?>
   <?php
   ...
   <div class="form-group col-sm-6 col-md-6 enq-email"> 
      ...
      <?php }else{ 
         ...
         if($this->session->companey_id == 90 || $this->session->companey_id == 84){
            $disabled = '';?>
            <input name="email" class="form-control" <?=$disabled?> type="<?=$email_type?>" value="<?php echo $details->email ?>">  
            <?php
         }else{ ?>
            <input class="form-control" name="email" hidden type="<?=$email_type?>" value="<?php echo $details->email ?>">  
            <input class="form-control" <?=$disabled?> type="<?=$email_type?>" value="<?php echo $details->email ?>">  
         <?php
         }
         ?>
   ...
   <?php
    ...
    if(is_active_field(PRODUCT_CATEGORY_FIELD,$process_id)){
     ?>                
      <div class="form-group col-sm-6 col-md-6 enq-product">
         ...
         <select class="form-control" name="product_category" id="product_category" onchange="get_product()">
            ...
            <option value="<?= $cat['id']?>" <?php if($details->product_category_id == $cat['id']){ echo "selected"; } ?>><?= $cat['name']?></option>
            <?php } ?>
         </select>
      </div>
       <?php
    ...
    if(is_active_field(PRODUCT_SUBCATEGORY_FIELD,$process_id)){
     ?>                
      <div class="form-group col-sm-6 col-md-6 enq-product">
   ...
   <div class="form-group col-sm-6 col-md-6 enq-company">
      ...
      <label id="company_code"><?=$details->comp_code;?></label>
   </div>
   <?php }
