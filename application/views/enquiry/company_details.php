<div class="row">
  <div class="col-lg-12">
    <div style="    padding: 15px 0px 7px 15px; text-transform: capitalize;" align="center"><h2><?=$comp->company_name?></h2></div>
  </div>
</div>
...
<div class="row" style="padding:15px;">
  <div class="col-lg-12" style="padding: 0px;">
   ...
   <ul class="nav flex-column nav-tabs text-center">
...
<script type="text/javascript">
 function tabScroll(side)
 {
  ...
  <div class="tab-content">
      ...
      <div id="deals" class="container tab-pane "><br>
      ...
      <div id="accounts" class="container tab-pane fade active in"><br>
